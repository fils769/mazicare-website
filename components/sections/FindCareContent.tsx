                ...
                <div className="text-center max-w-4xl mx-auto">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 mb-10 justify-center">
                        <div className="flex items-center gap-2 bg-white px-4 py-2 rounded-lg border border-blue-100 shadow-sm">
                            ...
                            <span className="font-medium text-gray-900">{t.findCare.hero.badge1}</span>
                        </div>
                        <div className="flex items-center gap-2 bg-white px-4 py-2 rounded-lg border border-teal-100 shadow-sm">
                            ...
                            <span className="font-medium text-gray-900">{t.findCare.hero.badge2}</span>
                        </div>
                        <div className="flex items-center gap-2 bg-white px-4 py-2 rounded-lg border border-indigo-100 shadow-sm">
                            ...
                            <span className="font-medium text-gray-900">{t.findCare.hero.badge3}</span>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-2xl shadow-xl p-6 mb-10 max-w-3xl mx-auto border border-gray-200">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <div>
                                <h3 className="text-lg font-semibold text-gray-900">{t.findCare.hero.formTitle}</h3>
                                <p className="text-sm text-gray-600">{t.findCare.hero.formSubtitle}</p>
                            </div>
                        </div>
                        <div className="grid sm:grid-cols-2 gap-4 mb-6">
                            <div>
                                ...
                                <select
                                    ...
                                    defaultValue=""
                                >
                                    <option value="">{t.findCare.hero.careTypePlaceholder}</option>
                                    <option value="companionship">{t.findCare.hero.careTypes.companionship}</option>
                                    <option value="24-7">{t.findCare.hero.careTypes.liveIn}</option>
                                    <option value="post-hospital">{t.findCare.hero.careTypes.postHospital}</option>
                                    <option value="dementia">{t.findCare.hero.careTypes.dementia}</option>
                                    <option value="night-care">{t.findCare.hero.careTypes.nightCare}</option>
                                    <option value="mobility">{t.findCare.hero.careTypes.mobility}</option>
                                    <option value="personal-care">{t.findCare.hero.careTypes.personalCare}</option>
                                </select>
                            </div>
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-2">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {steps.map((step, index) => (
                        <div key={index} className="bg-white border border-gray-200 rounded-2xl p-6 hover:shadow-lg transition-shadow text-center relative overflow-hidden group flex flex-col h-full">
...
function SafetyVerification() {
    ...
    const verificationSteps = [
        ...
        {
            step: t.findCare.safety.step3Title,
            description: t.findCare.safety.step3Desc,
            color: "indigo"
        },
        {
                            ...
                            <div className="bg-gradient-to-br from-blue-600 to-teal-600 rounded-xl p-6 text-white">
                                ...
                                <div className="mb-6">
                                    <div className="flex items-center justify-between mb-4">
                                        <div className="text-xl font-bold">{t.findCare.dashboard.mockTitle}</div>
                                        <div className="text-sm bg-white/20 px-3 py-1 rounded-full">{t.findCare.dashboard.mockToday}</div>
                                    </div>

                                    {/* Schedule */}
                                    <div className="bg-white/10 rounded-lg p-4 mb-4">
                                        <div className="flex items-center justify-between mb-2">
                                            <div className="font-medium">{t.findCare.dashboard.mockSchedule}</div>
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <div className="font-medium">{t.findCare.dashboard.mockCaregiver}</div>
                                                <div className="text-sm opacity-80">{t.findCare.dashboard.mockRole}</div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-white/10 rounded-lg p-4">
                                        <div className="font-medium mb-2">{t.findCare.dashboard.mockNoteTitle}</div>
